...
This document describes how @sebastienrousseau/knip-config is run: who decides what, how
...
@sebastienrousseau/knip-config is **maintainer-led**. As of the current release line it has a single
