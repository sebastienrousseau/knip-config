...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/knip-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fknip-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/knip-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14510"><img src="https://img.shields.io/cii/level/14510?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Dead Code & Unused Dependency Audit](#dead-code--unused-dependency-audit) — before and after rule comparison
...
Install `@sebastienrousseau/knip-config` as a development dependency:
...
Knip reads `knip.json`, or a JS config that requires this package.
...
`@sebastienrousseau/knip-config` solves this with three deliberate engineering choices:
...
When maintaining dynamic meta-programming codebases where runtime `eval` or dynamic string imports prevent static AST dependency analysis.
